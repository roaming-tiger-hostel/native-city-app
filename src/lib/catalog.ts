...
export const GUESTS: GuestProfile[] = [
  {
    ...
    language: "en",
    segment: { ko: "동남아 무슬림 유학생", en: "SE Asian Muslim student" },
    constraints: ["no-pork", "late-night", "english-ok"],
    porkFree: true,
    lateNight: true,
  },
  {
    ...
    language: "en",
    segment: { ko: "영미권 백패커", en: "Anglophone backpacker" },
    constraints: ["budget", "walk"],
    lateNight: true,
  },
  {
    id: "yuki",
    ...
    language: "en",
    segment: { ko: "일본 직장인 단기여행", en: "Japanese short business trip" },
    constraints: ["efficient", "lunch"],
  },
];
